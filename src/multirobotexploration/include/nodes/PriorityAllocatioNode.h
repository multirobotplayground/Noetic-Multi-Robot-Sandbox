...
class PriorityAllocatioNode {
    public:
        PriorityAllocatioNode();
        ~PriorityAllocatioNode();
    ...
    private:
        ...
        int SelectFrontier(multirobotsimulations::Frontiers& centroids, tf::Vector3& selectFrontierWorld, const int& id=-1);
